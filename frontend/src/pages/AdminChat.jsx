...
export default function AdminChat() {
    ...
    return (
        <div className="flex flex-col md:flex-row border-t border-slate-300 py-4 bg-slate-100 min-h-screen">
            ...
            <main className="m-3 flex min-w-0 flex-1 flex-col sm:m-6 md:mr-10 md:my-10">
                <h1 className="mb-4 text-2xl font-semibold text-center md:text-start text-[#132A36]">
                    SUPPORT CHAT
                </h1>

                <div className="flex h-[calc(100vh-9rem)] min-h-[32rem] flex-col overflow-hidden rounded-lg border border-slate-300 bg-white sm:h-[70vh] sm:min-h-0 md:flex-row">
                    {/* Sidebar */}
                    <div className="flex h-44 w-full shrink-0 flex-col border-b border-slate-300 md:h-auto md:w-2/5 md:max-w-xs md:border-b-0 md:border-r">
                        <div className="border-b border-slate-300 px-3 py-3 text-sm font-semibold text-[#132A36] sm:px-4">
                            Conversations
                        </div>
                    ...
                    <div className="flex min-h-0 min-w-0 flex-1 flex-col">
                        {!activeId ? (
                            ...
                            <>
                                <div className="flex flex-wrap items-center justify-between gap-2 border-b border-slate-300 px-3 py-3 sm:flex-nowrap sm:px-4">
                                    <div className="min-w-0">
                                        <span className="block truncate font-semibold text-[#132A36]">
                                    ...
                                    <div className="flex w-full gap-2 sm:w-auto">
                                        <button
                                            ...
                                            className="flex-1 rounded-md border border-red-300 px-2 py-2 text-xs font-semibold text-red-700 hover:bg-red-50 sm:flex-none sm:px-3"
                                        >
                                            Clear chat
                                        </button>
                                        {activeConversation?.mode !== "ai" && (
                                            <button
                                                ...
                                                className="flex-1 rounded-md border border-slate-300 px-2 py-2 text-xs font-semibold text-[#132A36] hover:bg-slate-50 sm:flex-none sm:px-3"
                                            >
                                                Close connection
                                            </button>
                                        )}
                                ...
                                <form onSubmit={handleSend} className="flex gap-2 border-t border-slate-300 p-2 sm:p-3">
                                    <input
                                        value={text}
                                    ...
                                    <button
                                        ...
                                        className="shrink-0 rounded-md bg-[#104185] px-3 py-2 text-sm font-semibold text-white disabled:opacity-50 sm:px-5"
                                    >
                                        Send
                                    </button>
                                </form>
