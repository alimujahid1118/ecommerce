...
export default function Header({ menuOpen, setMenuOpen, profileOpen, setProfileOpen }) {
    useEffect(() => {
    ...
    return(
        <>
            ...
            <div className="flex flex-row items-center justify-between px-6 sticky top-0 z-50 bg-white">
                    ...
                    <div className="bg-white fixed inset-y-0 right-0 w-96 z-50 overflow-y-auto overscroll-none">
                        <div className="flex flex-col px-10 pb-10 pt-6">
                            ...
                            <div className="flex flex-col gap-6 pl-6 py-10 text-[#132A36] items-center">
                                ...
                                <form className="flex flex-col gap-2 w-full md:max-w-[500px]">
                                    <div className="flex flex-col gap-4">
                                        <p className="font-semibold">Email</p>
                                        <input type="text" placeholder="eg. johndoe@gmail.com" className="border-[1px] border-slate-300 px-4 py-2 rounded-lg"/>
                                    </div>
                                    <div className="flex flex-col gap-4">
                                        <p className="font-semibold">Password</p>
                                        <input type="text" placeholder="********" className="border-[1px] border-slate-300 px-4 py-2 rounded-lg"/>
                                    </div>
                                    <button className="bg-[#132A36] text-white font-semibold mt-5 py-2 rounded-lg">LOG IN</button>
                                </form>
                                <p className="text-md">
